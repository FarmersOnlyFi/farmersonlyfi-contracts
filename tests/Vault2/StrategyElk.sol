...
import "../interfaces/IElkStake.sol";
import "../interfaces/IWETH.sol";

import "./BaseStrategyLP.sol";

contract StrategyElk is BaseStrategyLP {
    ...
    function _vaultDeposit(uint256 _amount) internal override {
        IElkStake(stakingPoolAddress).stake(_amount);
    }
    
    function _vaultWithdraw(uint256 _amount) internal override {
        IElkStake(stakingPoolAddress).withdraw(_amount);
    }
    ...
    function vaultSharesTotal() public override view returns (uint256) {
        uint256 balance = IElkStake(stakingPoolAddress).balanceOf(address(this));
        return balance;
    }
    ...
    function _resetAllowances() internal override {
        ...
        IERC20(wantAddress).safeApprove(stakingPoolAddress, uint256(0));
